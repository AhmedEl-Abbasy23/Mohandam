...
class _SearchViewState extends State<SearchView> {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> _getSearchData() {
    return _productsData.where('title', isGreaterThanOrEqualTo: _searchValue).where('title', isLessThanOrEqualTo: '$_searchValue\uf7ff')
        .orderBy('title').startAt([_searchValue]).endAt(['$_searchValue\uf7ff']).snapshots();
  }
  @override
      ...
      appBar: AppBar(
        ...
        child: StreamBuilder<QuerySnapshot?>(
          ...
          builder: (context, snapshot) {
            return snapshot.hasData && snapshot.data != null ? Column( children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            cursorColor: const Color(0xff096f77), style: const TextStyle(
                              fontSize: 16.0,
                            ),
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return GestureDetector(
                                ...
                                child: Hero( tag: snapshot.data!.docs[index].id,
                                  child: ProductItem(
