                                      ...
                                      onTap: () {
                                        ...
                                        navigatePush(
                                            ...
                                            ProductDetailsView(
                                              ...
                                              productInFavorite: snapshot.data!
                                                  .docs[index]['inFavorite'],
                                              productQuantity: snapshot.data!
                                                  .docs[index]['quantity'],
                                            ));
                                      },
                                      child: Hero(
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        IconButton(
                                                          onPressed: () {
                                                            // edit product
                                                            navigatePush(context, EditProductView(
                                  ...
                                  children: [
                                    ...
                                    Card(
                                      ...
                                      child: Container(
                                        padding: const EdgeInsets.symmetric(
                                            vertical: 10.0, horizontal: 20.0),
                                        height: translator.activeLanguageCode ==
                                                'en'
                                            ? 350.0
                                            : 450.0,
                                        width: double.infinity,
